...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) { // trim verifica se ta fazio
			exception.addError("email", "Field can´t be empty"); // o nome ñ pode ser fazio
		}
		obj.setEmail(txtEmail.getText()); // precisa convert pois ja é uma String
		...
		obj.setBaseSalary(Utils.tryParseToDouble(txtBaseSalary.getText())); //convertido
